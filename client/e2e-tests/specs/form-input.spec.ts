...
describe('Form Input Tests', () => {
  ...
  describe('Interest Rate Input Tests', () => {
    ...
    test('should allow adding multiple interest rate periods', async () => {
      ...
      const addButtonExists = await loanForm.elementExists(selectors.ADD_INTEREST_RATE_PERIOD_BUTTON);
    ...
    test('should calculate date ranges for interest periods correctly', async () => {
      ...
      const dateRangeExists = await loanForm.elementExists('[data-testid^="interest-rate-date-range-0-start"]');
