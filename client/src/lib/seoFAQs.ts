...
export const mortgageFAQs: FAQsByLanguage = {
  en: [
    ...
    },
    {
      ...
      answer:
        'Mortgage calculators provide reasonably accurate estimates when you input correct information. However, they may not account for all variables that affect your actual mortgage payment, such as property taxes, homeowners insurance, HOA fees, or private mortgage insurance (PMI). Our calculator includes options for these additional costs to provide a more comprehensive estimate.',
    },
    {
      question: 'What is the difference between fixed-rate and adjustable-rate mortgages?',
      answer:
        'A fixed-rate mortgage maintains the same interest rate throughout the entire loan term, resulting in consistent monthly payments. An adjustable-rate mortgage (ARM) has an interest rate that changes periodically based on market conditions, typically after an initial fixed period. Our calculator allows you to model both types by setting different interest rate periods.',
    },
    {
      question: 'How do overpayments affect my mortgage?',
      answer:
        'Overpayments reduce your mortgage principal faster than scheduled payments, which can significantly reduce the total interest paid and shorten your loan term. Our calculator allows you to see the impact of different overpayment strategies, including one-time lump sums or regular monthly additional payments.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'The loan term (duration) significantly impacts both your monthly payment amount and the total interest paid over the life of the loan. Shorter terms (like 15 years) have higher monthly payments but much lower total interest costs compared to longer terms (like 30 years). Our calculator allows you to compare different loan terms to find the right balance for your financial situation.',
    },
    {
    ...
    },
    {
      ...
      answer:
        "Several strategies can reduce your mortgage costs: making a larger down payment, securing a lower interest rate, choosing a shorter loan term, making regular overpayments, refinancing when rates drop, or eliminating private mortgage insurance as soon as possible. Our calculator's comparison feature allows you to model different scenarios to find the most cost-effective approach for your situation.",
    },
    {
      question: 'What is the difference between equal installments and decreasing installments?',
      answer:
        'With equal installments (also called annuity), your total monthly payment remains the same throughout the loan term, but the proportion of principal and interest changes over time. With decreasing installments, you pay a fixed amount toward the principal each month, while the interest portion decreases over time, resulting in gradually decreasing total payments. Our calculator supports both repayment models so you can compare their impact.',
    },
    {
      question: 'How do interest rate changes affect my mortgage?',
      answer:
        'Even small changes in interest rates can significantly impact your monthly payments and the total cost of your mortgage. A 1% reduction in rate on a 30-year $300,000 mortgage could save over $60,000 in total interest. Our calculator allows you to model different interest rate scenarios and see their long-term effects on your loan.',
    },
  ],
  es: [
    {
