...
export default function About() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background font-sans text-foreground">
      <SEOHead pageTitle={t('about.title')} pageDescription={t('about.projectDescription')} />
        ...
        <div className="bg-card/80 backdrop-blur-sm rounded-xl shadow-xl p-10 lg:p-16">
          ...
          <section className="mb-12 transform transition-all duration-300 ">
            ...
            <ol className="grid gap-6">
              <li className="bg-muted rounded-lg">
                <div className="flex items-center gap-5 p-2">
                  <span className="flex-shrink-0 w-10 h-10 bg-primary/10 text-primary flex items-center justify-center text-lg font-semibold rounded-lg">
                    1
                  </span>
          ...
          <section className="mb-12 transform transition-all duration-300">
            ...
            <p className="text-foreground mb-6 leading-relaxed">
              {t('about.passionProjectDescription')}
            </p>
            ...
            <div className="mt-8">
              <div className="flex flex-col sm:flex-row items-center gap-8 p-2 bg-muted rounded-xl">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <strong className="text-foreground block mb-4 font-semibold text-xl">
                    Linkedin:
                  </strong>
                  <a
          ...
          <section className="transform transition-all duration-300">
            ...
            <p className="text-foreground mb-6 leading-relaxed">
              {t('about.developerInfoDescription')}
            </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold">
                      {parseInt(statistics.linesOfCode).toLocaleString()}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714a2.25 2.25 0 001.357 2.059l.71.355a1.067 1.067 0 01.64.972V16a2 2 0 01-2 2h-8a2 2 0 01-2-2v-1.302c0-.399.247-.767.64-.972l.71-.355a2.25 2.25 0 001.357-2.059"
                    />
                  </svg>
                  <div>
