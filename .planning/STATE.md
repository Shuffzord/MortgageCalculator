...
**Research completed:**
- WebMCP patterns (imperative API)
- React integration (standalone module)
- Calculator mapping (LoanDetails ↔ tool input)
- Testing approach (Jest mock + Chrome extension)

**Next step:** Plan phase 1 (TypeScript Foundation)
