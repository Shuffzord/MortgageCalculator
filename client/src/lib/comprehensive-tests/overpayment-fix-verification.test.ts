...
describe('Overpayment Fix Verification', () => {
  test('$250,000 loan with 5% interest and $10,000 overpayment in year 5', () => {
    ...
    console.log('Term reduction interest saved:', 
    ...
    console.log('Payment reduction interest saved:', 
    ...
    expect(paymentReductionResults.monthlyPayment).toBeLessThanOrEqual(standardResults.monthlyPayment);
