...
export function applyMultipleOverpayments(
  ...
  return performOverpayments(schedule, overpayments, loanStartDate, loanDetails);
}
...
export function performOverpayments(
  schedule: PaymentData[],
  overpayments: OverpaymentDetails[],
  loanStartDate?: Date, loanDetails: LoanDetails = {principal: 0, interestRatePeriods: [], loanTerm: 0, overpaymentPlans: [], startDate: new Date(), name: ''}
): PaymentData[] {
