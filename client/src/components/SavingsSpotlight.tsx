...
const SavingsSpotlight: React.FC<SavingsSpotlightProps> = ({
      ...
      <div className="bg-green-50 p-4 rounded-lg border border-green-100 mt-4">
        <div className="text-center">
          <p className="text-sm text-green-600">
            {t('summary.calculatingSavings', 'Calculating savings...')}
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div
      id="overpayment-savings-spotlight"
      className="bg-green-50 p-4 rounded-lg border border-green-100 mt-4"
    >
      <div className="text-center mb-4">
        ...
        <p className="text-sm text-green-600">{t('summary.impactDescription')}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm text-center">
          ...
          <p className="text-xl font-bold text-gray-900 mt-1">{formatTimePeriod(timeSaved)}</p>
        </div>
