...
type LegacyLoanDetails = LoanDetails & {
  interestRate?: number;
...
export default function Home() {
  ...
  const originalTotalInterest =
    monthlyPayment * (loanDetails.loanTerm * 12) - loanDetails.principal;
  ...
  const handleLoad = (calculation: LoanDetails) => {
    ...
    const updatedCalculation: LegacyLoanDetails = { ...calculation };

    // If it's an old format calculation, convert to new format
    if (
      !updatedCalculation.interestRatePeriods ||
      updatedCalculation.interestRatePeriods.length === 0
    ) {
    ...
    if (!updatedCalculation.overpaymentPlans || updatedCalculation.overpaymentPlans.length === 0) {
      ...
      const reduceTerm = updatedCalculation.reduceTermNotPayment ?? true;
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4">
              <div
                className="rounded-lg shadow-md border overflow-hidden animate-fade-in"
                style={{ backgroundColor: '#FFFFFF', borderColor: '#E5E7EB' }}
              >
                <div
                ...
                <div className="p-6">
                  <CalculatorForm loanDetails={loanDetails} onFormSubmit={handleFormSubmit} />
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              >
                ...
                <div className="p-6">
                  <AmortizationSchedule schedule={schedule} loanDetails={loanDetails} />
                </div>
              </div>
            </div>
          </div>
